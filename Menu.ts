...
function sobre(): void {
    ...
    console.log("Lucas Ribeiro de Jesus - lrr.lucasribeiro@gmail.com");
...
function criarContasTeste(): void{
    ...
    contas.cadastrar(new ContaCorrente(contas.gerarNumero(), 1234, 'Julia Bandeira', 1, 1000000.00, 100000.00));
    contas.cadastrar(new ContaCorrente(contas.gerarNumero(), 4578, 'Marcos Braz', 1,  1000.00, 100.00));

    // Instâncias da Classe ContaPoupança
    contas.cadastrar(new ContaPoupanca(contas.gerarNumero(), 5789, "Leila Pereira", 2, 10000, 10));
    contas.cadastrar(new ContaPoupanca(contas.gerarNumero(), 5698, "Abel Ferreira", 2, 15000, 15));
